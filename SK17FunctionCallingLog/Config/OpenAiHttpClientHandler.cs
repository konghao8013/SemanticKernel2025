...
{  
    protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
    {
        ...
        logger.LogInformation("KH日志 Sending '{Request.Method}' to '{Request.Host}{Request.Path}' with content {Request.Content}",
            request.Method,
        ...
        logger.LogInformation(
            "KH日志  Received '{Response.StatusCodeInt} {Response.StatusCodeString}' with content {Response.Content}",
